        ...
        <div class="col-3">
            ...
            <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                    ...
                    <div id="collapseOne"
                         class="accordion-collapse collapse <?php echo strpos($cpl->kode, 'SP') === 0 ? 'show' : ''; ?>"
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button fw-bold bg-light collapsed" type="button"
                            ...
                            Pengetahuan (PP)<span
                                class="badge text-bg-primary ms-2">{{ countCPL('PP', $data_cpl) }}</span>
                        </button>
                    </h2>
                    <div id="collapseTwo"
                         class="accordion-collapse collapse <?php echo strpos($cpl->kode, 'PP') === 0 ? 'show' : ''; ?>"
                         data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            @foreach ($data_cpl as $data)
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseThree"
                         class="accordion-collapse collapse <?php echo strpos($cpl->kode, 'KU') === 0 ? 'show' : ''; ?>"
                         data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            @foreach ($data_cpl as $data)
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseFour"
                         class="accordion-collapse collapse <?php echo strpos($cpl->kode, 'KK') === 0 ? 'show' : ''; ?>"
                         data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            @foreach ($data_cpl as $data)
